            ...
            <div className="footer-gray">
                <div className="footer-custom">
                    <div className="footer-lists">
                        ...
                        <div className="footer-list-wrap">
                            <h6 className="ftr-hdr">About Mobile bazar.com</h6>
                            <ul className="ftr-links-sub">
                                <li><HashLink to="/home#home">Our Company</HashLink></li>
                                <li><HashLink to="/home#home">Careers</HashLink></li>
                                <li><HashLink to="/home#home">Mobile Showroom</HashLink></li>
                                ...
                                <li><HashLink to="/home#home">MOBILE BAZAR.COM BLOG</HashLink></li>
                            </ul>
                        </div>
                        <div className="footer-list-wrap">
                    ...
                    <div className="footer-legal">
                        <p>&copy; Mobile bazar.com Inc. All Rights Reserved. | <HashLink to="/" >Privacy Policy</HashLink> | <HashLink to="/" >Terms of Use</HashLink> | <HashLink to="/" >Terms of Sale</HashLink></p>
